<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site_Admin.master" AutoEventWireup="true" CodeFile="ReportDailyProject.aspx.cs" Inherits="Report" %>
    ...
    <table cellspacing="10" align="center" style="margin:0 auto" >
        <tr>
            ...
            <td><asp:DropDownCheckBoxes ID="chkEmployee" runat="server" DataTextField="EmpName" 
                        DataValueField="EmpId" UseButtons="True" UseSelectAllNode="true" AddJQueryReference="True">
